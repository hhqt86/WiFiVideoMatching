...
public class Config {
	static int maximumBlobCount = 12000;  // Maximum blob count in the Suntec video
	static int maximumFrameCount = 20000;// Maximum frame count in the Suntec video, 30 fps
	static int maximumWifiReportCount = 12000;
	static double averageScoreOfLeaderThreshold = 0.7;
	static double rtRealWifi = 0.25;
	static Coordinate noPoint = new Coordinate(-1000,-1000);
	...
	static int maxRankThresholdSlidingWindow = 1;
	static int historyWindowLength = 2;
